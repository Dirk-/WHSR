...
void WHSR::TimerSet(unsigned long ms, void (*isrfunction)())
{
    ...
    nrf_timer_shorts_enable(NRF_TIMER3, TIMER_SHORTS_COMPARE1_CLEAR_Msk);
    ...
    nrf_timer_cc_write(NRF_TIMER3, NRF_TIMER_CC_CHANNEL1,
                       ms * 1000);
    nrf_timer_int_enable(NRF_TIMER3, NRF_TIMER_INT_COMPARE1_MASK);
#endif
}
...
{
    if (nrf_timer_event_check(NRF_TIMER3, NRF_TIMER_EVENT_COMPARE1))
    {
        nrf_timer_event_clear(NRF_TIMER3, NRF_TIMER_EVENT_COMPARE1);
